                ...
                if(numTurns<9){
                    ...
                    if(victory=="none"){
                        ...
                        setTimeout(()=>{
                          ...
                          document.getElementById(tag).className="animate__animated animate__rubberBand";
                        },10);
...
function gameDynamic(turn){
    for(let i=0;i<3;i++){
        if(gameMatrix[i][0]==turn && gameMatrix[i][1]==turn && gameMatrix[i][2]==turn){
            ...
            setTimeout(()=>{
              document.getElementById(`${i}0`).className="animate__animated animate__heartBeat";
            },1000);
          setTimeout(()=>{
              document.getElementById(`${i}1`).className="animate__animated animate__heartBeat";
            },1500);
          setTimeout(()=>{
              document.getElementById(`${i}2`).className="animate__animated animate__heartBeat";
            },2000);
            break;
        }
        if(gameMatrix[0][i]==turn && gameMatrix[1][i]==turn && gameMatrix[2][i]==turn){
            ...
            setTimeout(()=>{
              document.getElementById(`0${i}`).className="animate__animated animate__heartBeat";
            },1000);
          setTimeout(()=>{
              document.getElementById(`1${i}`).className="animate__animated animate__heartBeat";
            },1500);
          setTimeout(()=>{
              document.getElementById(`2${i}`).className="animate__animated animate__heartBeat";
            },2000);
            break;
        }
    }
    if(gameMatrix[0][0]==turn && gameMatrix[1][1]==turn && gameMatrix[2][2]==turn){
        ...
        setTimeout(()=>{
              document.getElementById(`00`).className="animate__animated animate__heartBeat";
            },1000);
          setTimeout(()=>{
              document.getElementById(`11`).className="animate__animated animate__heartBeat";
            },1500);
          setTimeout(()=>{
              document.getElementById(`22`).className="animate__animated animate__heartBeat";
            },2000);
    }
    if(gameMatrix[0][2]==turn && gameMatrix[1][1]==turn && gameMatrix[2][0]==turn){
        ...
        setTimeout(()=>{
              document.getElementById(`20`).className="animate__animated animate__heartBeat";
            },1000);
          setTimeout(()=>{
              document.getElementById(`11`).className="animate__animated animate__heartBeat";
            },1500);
          setTimeout(()=>{
              document.getElementById(`02`).className="animate__animated animate__heartBeat";
            },2000);
    }
